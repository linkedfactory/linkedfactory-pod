...
public class BindingSetParquetWriter extends ParquetWriter<BindingSet> {

	/**
	 * Create a new {@link BindingSetParquetWriter}.
	 *
	 ...
	 * @throws IOException
	 */
	BindingSetParquetWriter(Path file, WriteSupport<BindingSet> writeSupport, CompressionCodecName compressionCodecName, int blockSize, int pageSize, boolean enableDictionary, boolean enableValidation, ParquetProperties.WriterVersion writerVersion, Configuration conf) throws IOException {
