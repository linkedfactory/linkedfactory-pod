...
import io.github.linkedfactory.core.kvin.memtable.LmdbUtil.Transaction;
import io.github.linkedfactory.core.kvin.memtable.model.*;
...
import static io.github.linkedfactory.core.kvin.memtable.LmdbUtil.E;
import static io.github.linkedfactory.core.kvin.memtable.LmdbUtil.openDatabase;
...
class ValueStore extends AbstractValueFactory {
	...
	protected boolean useRefCounting = true;
	/**
	 * Used to do the actual storage of values, once they're translated to byte arrays.
	 */
	private long env;
